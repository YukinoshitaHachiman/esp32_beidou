...
static lv_disp_draw_buf_t disp_buf;  // 包含内部图形缓冲区
...
void lcd_init(void)
{
    ...
    #if CONFIG_EXAMPLE_LCD_CONTROLLER_GC9A01 || CONFIG_EXAMPLE_LCD_CONTROLLER_ST7789
...
void lvgl_init(void)
{
    ...
    // 为LVGL创建定时器（使用esp_timer生成2ms周期性事件）
